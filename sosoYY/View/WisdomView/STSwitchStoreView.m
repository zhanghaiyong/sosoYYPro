...
//                    mode.info = [NSString stringWithFormat:@"该店已购买¥%@元,达到发货金额.",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.surplusmoney.floatValue + numPrice.floatValue]]];
                ...
                if (mode.surplusmoney.floatValue + numPrice.floatValue >= mode.lowestFreeShippingAmount.floatValue) {//满邮金额
                    ...
                    mode.info = [NSString stringWithFormat:@"还差包邮¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestFreeShippingAmount.floatValue - mode.surplusmoney.floatValue - numPrice.floatValue]]];
                    
                }
            }else{
                //已购买mode.surplusmoney.floatValue + numPrice.floatValue
                mode.info = [NSString stringWithFormat:@"还差发货¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestdeliveryAmount.floatValue - mode.surplusmoney.floatValue - numPrice.floatValue]]];
            }
...
//                        mode.info = [NSString stringWithFormat:@"该店已购买¥%@元,达到发货金额.",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.surplusmoney.floatValue]]];
                        ...
                        if (mode.surplusmoney.floatValue  >= mode.lowestFreeShippingAmount.floatValue) {//满邮金额
                            ...
                            mode.info = [NSString stringWithFormat:@"还差包邮¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestFreeShippingAmount.floatValue - mode.surplusmoney.floatValue]]];
                            
                        }
                    }else{
                        //已购买mode.surplusmoney.floatValue
                        mode.info = [NSString stringWithFormat:@"还差发货¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestdeliveryAmount.floatValue - mode.surplusmoney.floatValue]]];
                    }
...
//                        mode.info = [NSString stringWithFormat:@"该店已购买¥%@元,达到发货金额.",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.surplusmoney.floatValue + yuPrice]]];
                        ...
                        if (mode.surplusmoney.floatValue + yuPrice >= mode.lowestFreeShippingAmount.floatValue) {//满邮金额
                            ...
                            mode.info = [NSString stringWithFormat:@"还差包邮¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestFreeShippingAmount.floatValue - (mode.surplusmoney.floatValue + yuPrice)]]];
                            
                        }
                    }else{
                        //已购买mode.surplusmoney.floatValue + numPrice.floatValue - oldPrice
                        mode.info = [NSString stringWithFormat:@"还差发货¥%@",[STCommon setHasSuffix:[NSString stringWithFormat:@"%.2f",mode.lowestdeliveryAmount.floatValue - (mode.surplusmoney.floatValue + yuPrice)]]];
                    }
