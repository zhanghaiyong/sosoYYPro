...
-(void)selectBtn:(UIButton *)btn{
   ...
   UIImageView *imgv = [self viewWithTag:kSTListImgtag + btn.tag - kSTListBtntag];
    ...
    if (_delegate && [ _delegate respondsToSelector:@selector(g_setSelectBtnTag:andSelected:)]) {
        [_delegate g_setSelectBtnTag:btn.tag - kSTListBtntag andSelected:isSeleceted];
        }
    typeTag = btn.tag;
