...
@interface STStorewideFilterView ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,STStorewideFilterFootViewDelegte>{
    NSArray *titleAry;
}
...
@implementation STStorewideFilterView
...
-(void)g_setStorewideFilterFinished{
  [[NSNotificationCenter defaultCenter] postNotificationName:@"hiddenFilterView" object:nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"storewideProducttype" object:self userInfo:_productDict];
}
