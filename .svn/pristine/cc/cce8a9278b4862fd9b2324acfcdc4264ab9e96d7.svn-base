...
- (IBAction)ServiceQQClick:(id)sender {
    ...
    if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"mqq://"]]) {
        [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"mqq://im/chat?chat_type=wpa&uin=%@&version=1&src_type=web",[self.QQ stringByReplacingOccurrencesOfString:@" " withString:@""]]]];
    }else{
