...
@interface STWisdomSearchBtnView (){
    NSInteger typeTag;
    BOOL isSeleceted;
    NSInteger oldtag;
}
...
@implementation STWisdomSearchBtnView
...
-(void)selectBtn:(UIButton *)btn{
    ...
    if (_delegate && [ _delegate respondsToSelector:@selector(g_setWisdomSearchBtnTag:andSelected:)]) {
        [_delegate g_setWisdomSearchBtnTag:btn.tag - kSTListBtntag andSelected:isSeleceted];
    }
    typeTag = btn.tag;
